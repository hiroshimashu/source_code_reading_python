...
const wrapperY = 2045 / 3812 * windowHeight;

const backgroundWidth = windowWidth * 0.831;
...
const backgroundY = 2046 / 3812 * windowHeight;


const planWidth = windowWidth *  0.277;
const planHeight = windowHeight *  0.007;
const planX =  windowWidth * 100 / 750;
const planY = 2068 / 3812 * windowHeight;

const priceWidth = windowWidth *  0.257;
const priceHeight = windowHeight *  0.007;
const priceX =  windowWidth * 470 / 750;
const priceY = 2069 / 3812 * windowHeight;

const exWidth = windowWidth *  0.297;
const exHeight = windowHeight *  0.006;
const exX =  windowWidth * 96 / 750;
const exY = 2149 / 3812 * windowHeight;

const exDetailWidth = windowWidth *  0.341;
const exDetailHeight = windowHeight *  0.004;
const exDetailX =  windowWidth * 406 / 750;
const exDetailY = 2152 / 3812 * windowHeight;
